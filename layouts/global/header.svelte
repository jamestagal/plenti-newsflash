...
<header class="header" id="header">
  <nav class="navbar container">
    ...
    <div class="menu" id="menu">
      <ul class="list">
        ...
        <li class="list-item screen-lg-hidden ">
          <a href="." class="list-link" on:click|preventDefault={$user.login()}>Sign in</a>
        </li>
        <li class="list-item screen-lg-hidden">
    ...
    <div class="list list-right">
      ...
      <a href="." class="login-btn list-link screen-sm-hidden" on:click|preventDefault={$user.login()}>Sign in</a>
      <a href="sign-in" class="btn sign-up-btn fancy-border screen-sm-hidden">
        <span>Sign up</span>
      </a>
    </div>
  </nav>
